...
check the out-of-the-box supported boards by referring the folder manifests,

## Getting started

There are currently two ways of using this repository, via the LVGL project creator, 
...
* Go to this project root: `$ mkdir /path/to/this/repo`
